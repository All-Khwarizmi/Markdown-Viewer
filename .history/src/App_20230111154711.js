...
An image : ![Paris le jour](/image.jpeg)
...
~~~
![freeCodeCamp Logo]((https://images.unsplash.com/flagged/1/apple-gear-looking-pretty.jpg?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1170&q=80))
`;
...
function App() {
  ...
  return (
    <div className='App'>
      ...
      <h3>Preview</h3><img src='image.jpeg' alt=''/>
